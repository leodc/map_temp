function addGeoPath(){
  ...
  // .overlayGeoJson(_geojson.features, "state", function (d) {
  //     return d.properties.data[selectedYear]["Ganador"];
  ...
  dcMap = dc.leafletChoroplethChart('#map');
  ...
  dcMap
    ...
    .group(partidoDimension.group())
    .colors(getPartidoColor)
    .geojson(_geojson.features)
    .featureKeyAccessor(function(feature) {
        return feature.properties.data[selectedYear]["Ganador"];
    }).valueAccessor(function(kv) {
      return kv.key;
    })
  ...
  //   .projection(d3.geo.mercator())
  //   .colors(getPartidoColor)
  //   .overlayGeoJson(_geojson.features, "duration", function(d) {
  //       return d.properties.data[selectedYear]["Ganador"];
  //   }).valueAccessor(function(kv) {
  //     return kv.key;
  //   })
  ...
  // var center = L.geoJSON(Object.values(data[selectedState])).getBounds().getCenter();
  ...
  // var bounds = path.bounds(_geojson);
  ...
  //   .overlayGeoJson(Object.values(data[selectedState]), "Partido ganador", function (d) {
  //     return d.properties.data[selectedYear]["Ganador"];
  //   });
  //
  //   // .dimension(partidoDimension)
  ...
  //   // .colors(getPartidoColor)
  //   // .projection(d3.geo.mercator())
  //   // .overlayGeoJson(Object.values(data[selectedState]), "Community", function(d){
  //   //   return d.properties.data[selectedYear]["Ganador"];
  //   // })
  //
  // chart.render();
